...
class GroupController extends AbstractController
{
     ...
     * @Template()
     *
     * @param \AppBundle\Entity\Staff\Group $group Group to display
     * @return array
     */
     ...
     * @Method("POST")
     * @Template("AppBundle:Staff/Group:new.html.twig")
     *
     ...
     * @Template()
     *
     * @param \AppBundle\Entity\Staff\Group $group Group item to edit
     * @return array
     */
     ...
     *
     * @param \AppBundle\Entity\Staff\Group             $group   Group item to update
     * @param \Symfony\Component\HttpFoundation\Request $request Form request
     * @return array
     */
     ...
     * @Method("DELETE")
     *
     * @param \AppBundle\Entity\Staff\Group             $group   Group item to delete
     * @param \Symfony\Component\HttpFoundation\Request $request Form request
