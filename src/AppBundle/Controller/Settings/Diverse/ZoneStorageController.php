...
class ZoneStorageController extends AbstractController
{
     ...
     * @Template()
     *
     * @param \AppBundle\Entity\Settings\Diverse\ZoneStorage $zonestorage ZoneStorage to display
     * @return array
     */
     ...
     * @Method("POST")
     * @Template("AppBundle:Settings/Diverse/ZoneStorage:new.html.twig")
     *
     ...
     * @Template()
     *
     * @param \AppBundle\Entity\Settings\Diverse\ZoneStorage $zonestorage ZoneStorage item to edit
     * @return array
     */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Settings/Diverse/ZoneStorage:edit.html.twig")
     *
     * @param \AppBundle\Entity\Settings\Diverse\ZoneStorage $zonestorage ZoneStorage item to update
     * @param \Symfony\Component\HttpFoundation\Request      $request     Form request
     * @return array
     */
     ...
     * @Method("DELETE")
     *
     * @param \AppBundle\Entity\Settings\Diverse\ZoneStorage $zonestorage ZoneStorage item to delete
     * @param \Symfony\Component\HttpFoundation\Request      $request     Form request
     * @return array
     */
