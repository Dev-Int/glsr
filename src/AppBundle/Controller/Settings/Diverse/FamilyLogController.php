...
class FamilyLogController extends AbstractController
{
     ...
     * @Template()
     *
     * @param \AppBundle\Entity\Settings\Diverse\FamilyLog $familylog FamilyLog item to display
     * @return array
     */
     ...
     * @Method("POST")
     * @Template("AppBundle:Settings/Diverse/FamilyLog:new.html.twig")
     *
     ...
     * @Method("PUT")
     * @Template("AppBundle:Settings/Diverse/FamilyLog:edit.html.twig")
     *
     * @param \AppBundle\Entity\Settings\Diverse\FamilyLog $familylog FamilyLog item to update
     * @param \Symfony\Component\HttpFoundation\Request    $request   Form request
     * @return array
     */
     ...
     * @Method("DELETE")
     *
     * @param \AppBundle\Entity\Settings\Diverse\FamilyLog $familylog FamilyLog item to delete
     * @param \Symfony\Component\HttpFoundation\Request    $request   Form request
     * @return array
     */
