<?php
/**
 * UserController Controller of users.
 *
 * PHP Version 7
 *
...
class UserController extends AbstractAppController
{
     ...
     * @Template()
     *
     * @param \App\Entity\Staff\User $user User item to display
     * @return array
     */
     ...
     * @Method("POST")
     * @Template("staff/user/new.html.twig")
     *
     ...
     * @Template()
     *
     * @param \App\Entity\Staff\User $user User item to edit
     * @return array
     */
     ...
     * @Method("PUT")
     * @Template("staff/user/edit.html.twig")
     *
     * @param \App\Entity\Staff\User                    $user    User item to update
     ...
     * @Method("DELETE")
     *
     * @param \App\Entity\Staff\User                    $user    User item to delete
     * @param \Symfony\Component\HttpFoundation\Request $request Form request
     * @return \Symfony\Component\HttpFoundation\RedirectResponse
     */
     ...
     * Get user roles.
     *
     * @param \App\Entity\Staff\User $user
