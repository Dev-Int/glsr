...
class DeleteSettingsControllerTest extends AbstractControllerTest
{
    final public function testDeleteCompanySuccess(): void
    {
        ...
        $this->client->request('DELETE', '/api/administration/settings/delete/a136c6fe-8f6e-45ed-91bc-586374791033');
        ...
        self::assertTrue($response->isRedirect('/api/administration/settings/'));
    }
}
